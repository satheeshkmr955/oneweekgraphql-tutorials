...
import { Cart as CartModal, CartItem as CartItemModal } from '@prisma/client';
...
export type RemoveItemFromCardInput = {
  cartId: Scalars['ID']['input'];
  id: Scalars['ID']['input'];
};
...
export type ResolversTypes = {
  ...
  Cart: ResolverTypeWrapper<CartModal>;
  CartItem: ResolverTypeWrapper<CartItemModal>;
  ...
  RemoveItemFromCardInput: RemoveItemFromCardInput;
